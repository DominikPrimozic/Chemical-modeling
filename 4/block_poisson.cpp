...
int main(){
    ...
    std::ifstream inputFile("input/poisson/input.txt");
    ...
    std::string path="output/poisson/" + std::to_string(bottom) +"_"+ std::to_string(left)  +".txt";

    rectangular_rod rr(N,left,right,bottom,top);
    rr.solver_poisson(1.0/N,source);
