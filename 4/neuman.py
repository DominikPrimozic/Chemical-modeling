...
# Example usage
input_data = read_input_file("input/neuman/input.txt")
result = subprocess.run(["block_neuman.exe"], capture_output=True, text=True)

path=f"output/neuman/{input_data['bottom']:.6f}_{input_data['left']:.6f}.txt"
...
plt.savefig(f"neuman_{input_data['bottom']:.6f}_{input_data['left']:.6f}.png", dpi=300, bbox_inches='tight')
